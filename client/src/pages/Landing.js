...
const Landing = () => {
    ...
    const getProducts = async (limit, offset) => {
        axios.get(`${baseUrl}/product?limit=${limit}&offset=${offset}`)
        .then(res => {
        ...
        <>
            ...
            <div className='mt-32 max-w-screen-2xl items-center justify-between mx-auto p-4'>
                ...
                <div className='available-product'>
                    ...
                    <button type="button" className="ml-10 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Lihat lebih banyak</button>
                </div>
            </div>
            {/* footer */}
            <Footer></Footer>
