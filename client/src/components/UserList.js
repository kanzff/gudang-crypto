...
const UserList = ({user, getUsers}) => {
    ...
    const editUser = (id, name, email, phone, is_active) => {
    ...
    return (
        <>
            ...
            <div className='my-4 p-2 flex justify-start items-center'>
                ...
                <p className='w-80 text-center'>{user.name}</p>
                ...
                <div className='w-72 flex gap-8 justify-center text-white'>
                    ...
                    <button className='border rounded-lg bg-red-500 py-1 px-2' onClick={() => setDeleteUserModal(true)}>
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20" height="20" viewBox="0 0 50 50">
